...
class TunerConstants:
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 10.24
    ...
    _front_left_encoder_offset: units.rotation = 0.306640625
    _front_left_steer_motor_inverted = False
    _front_left_encoder_inverted = False

    _front_left_x_pos: units.meter = inchesToMeters(10.9375)
    _front_left_y_pos: units.meter = inchesToMeters(10.9375)

    # Front Right
    _front_right_drive_motor_id = 13
    _front_right_steer_motor_id = 14
    _front_right_encoder_id = 22
    _front_right_encoder_offset: units.rotation = -0.093994140625
    _front_right_steer_motor_inverted = False
    _front_right_encoder_inverted = False

    _front_right_x_pos: units.meter = inchesToMeters(10.9375)
    _front_right_y_pos: units.meter = inchesToMeters(-10.9375)

    # Back Left
    _back_left_drive_motor_id = 15
    _back_left_steer_motor_id = 16
    _back_left_encoder_id = 23
    _back_left_encoder_offset: units.rotation = -0.061279296875
    _back_left_steer_motor_inverted = False
    _back_left_encoder_inverted = False

    _back_left_x_pos: units.meter = inchesToMeters(-10.9375)
    _back_left_y_pos: units.meter = inchesToMeters(10.9375)

    # Back Right
    _back_right_drive_motor_id = 17
    _back_right_steer_motor_id = 18
    _back_right_encoder_id = 24
    _back_right_encoder_offset: units.rotation = 0.36083984375
    _back_right_steer_motor_inverted = False
    _back_right_encoder_inverted = False

    _back_right_x_pos: units.meter = inchesToMeters(-10.9375)
    _back_right_y_pos: units.meter = inchesToMeters(-10.9375)
